...
void editOwnerInfo()
{
    ...
    switch(inputNum)
    {
        case 1:
            cin >> owner.name;
            cout << "소유자의 이름이 수정 되었습니다." << endl;
            break;
        case 2:
            cin >> owner.phoneNumber;
            cout << "소유자의 전화번호가 수정 되었습니다." << endl;
            break;
        case 3:
            cin >> owner.email;
            cout << "소유자의 이메일이 수정 되었습니다." << endl;
            break;
        case 4:
            cin >> owner.address;
            cout << "소유자의 주소가 수정 되었습니다." << endl;
            break;
        case 5:
            cin >> owner.twitterAccount;
            cout << "소유자의 트위터 계정이 수정 되었습니다." << endl;
            break;
        default:
